...
%         Npoints = 100;
%         time_interval = kron(ones(1,Npoints), [0.1 4]);
...
%                 simin.signals.values = sc*linspace(0, 1.8, Npoints);
            case 2
